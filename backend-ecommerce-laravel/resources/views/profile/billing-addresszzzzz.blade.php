<div x-data="{
    ...
    <form x-ref="form" class="space-y-6"
        x-data="{
        ...
        <div class="space-y-2">
            ...
            <input id="billing_address1" type="text" name="billing[address1]" x-model="billingAddress.address1" placeholder="123 Main St" required
        ...
        <div class="space-y-2">
            ...
            <input id="billing_address2" type="text" name="billing[address2]" x-model="billingAddress.address2" placeholder="Apt, suite, etc."
                class="w-full px-4 py-3 rounded-lg border border-gray-300 dark:border-gray-600 focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 dark:bg-gray-700 dark:text-white transition duration-200">
        ...
        <div class="space-y-2">
            ...
            <input type="text" id="billing_city" name="billing[city]" x-model="billingAddress.city" placeholder="New York" required
                class="w-full px-4 py-3 rounded-lg border border-gray-300 dark:border-gray-600 focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 dark:bg-gray-700 dark:text-white transition duration-200">
        ...
        <div class="space-y-2">
            ...
            <input type="text" id="billing_zipcode" name="billing[zipcode]" x-model="billingAddress.zipcode" placeholder="10001" required
                class="w-full px-4 py-3 rounded-lg border border-gray-300 dark:border-gray-600 focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 dark:bg-gray-700 dark:text-white transition duration-200">
        ...
        <div class="pt-4">
            <button type="submit" :disabled="isSubmitting"
                ...
                <span x-show="!isSubmitting">Update Billing Address</span>
